...
// import { ERC20_ABI } from "@/constants/er20abi";
...
const COMMON_TOKENS = [
    ...
    { name: "Wrapped Bitcoin", symbol: "WBTC", address: "0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599", decimals: 8 },
    { name: "Chainlink", symbol: "LINK", address: "0x514910771AF9Ca656af840dff83E8264EcF986CA", decimals: 18 },
    { name: "Uniswap", symbol: "UNI", address: "0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984", decimals: 18 },
    { name: "Shiba Inu", symbol: "SHIB", address: "0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE", decimals: 18 }
];
...
export const WalletPage = () => {
    ...
    const renderTokenItem = ({ item }) => (
        <View style={styles.tokenItem}>
            <Text style={styles.tokenSymbol}>{item.symbol}</Text>
            <Text style={styles.tokenBalance}>{parseFloat(item.formattedBalance).toLocaleString(undefined, { maximumFractionDigits: 4 })}</Text>
        </View>
    );
